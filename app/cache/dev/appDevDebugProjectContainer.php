...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppMainBundle', ($this->targetDirs[2].'/Resources/SfWebAppMainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppMainBundle', ($this->targetDirs[3].'/src/SfWebApp/MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppBackOfficeBundle', ($this->targetDirs[2].'/Resources/SfWebAppBackOfficeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppBackOfficeBundle', ($this->targetDirs[3].'/src/SfWebApp/BackOfficeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppFrontOfficeBundle', ($this->targetDirs[2].'/Resources/SfWebAppFrontOfficeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppFrontOfficeBundle', ($this->targetDirs[3].'/src/SfWebApp/FrontOfficeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppCmsBundle', ($this->targetDirs[2].'/Resources/SfWebAppCmsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SfWebAppCmsBundle', ($this->targetDirs[3].'/src/SfWebApp/CmsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'testadmin', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SfWebAppMainBundle' => 'SfWebApp\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_12485128aae7dd95a31e91f69818a20217bfa3ed538106f23054474bf30a90df');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'SfWebAppFrontOfficeBundle:Registration:email.html.twig', 'resetting' => 'SfWebAppFrontOfficeBundle:Resetting:email.html.twig'), 'from_email' => array('confirmation' => array('username@mail.com' => 'username'), 'resetting' => array('username@mail.com' => 'username'))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.backoffice' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/backoffice'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_BackofficeService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'sf_web_app_cms_homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'sf_web_app_back_office_security_logout'));
        ...
        $g->setOptions(array('login_path' => 'sf_web_app_back_office_security_login', 'use_referer' => true, 'default_target_path' => 'SfWebApp_backofficebundle_home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
...
>>>>>>> master
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'sf_web_app_cms_homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $f->addHandler($this->get('security.logout.handler.session'));
...
>>>>>>> master
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FOSUserBundle', 1 => 'FrameworkBundle', 2 => 'SecurityBundle', 3 => 'TwigBundle', 4 => 'AsseticBundle', 5 => 'MonologBundle', 6 => 'SwiftmailerBundle', 7 => 'DoctrineBundle', 8 => 'SensioFrameworkExtraBundle', 9 => 'AppBundle', 10 => 'SfWebAppMainBundle', 11 => 'SfWebAppBackOfficeBundle', 12 => 'SfWebAppFrontOfficeBundle', 13 => 'SfWebAppCmsBundle', 14 => 'DebugBundle', 15 => 'WebProfilerBundle', 16 => 'SensioDistributionBundle', 17 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backoffice/connexion'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
...
<<<<<<< HEAD
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'backoffice', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56c5cb5241dce2.37195139'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56c5cb5241dce2.37195139')), true);
=======
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'backoffice', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56c5abed00bd60.43556602'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56c5abed00bd60.43556602')), true);
>>>>>>> master
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.bundles' => array(
                ...
                9 => 'AppBundle',
                10 => 'SfWebAppMainBundle',
                11 => 'SfWebAppBackOfficeBundle',
                12 => 'SfWebAppFrontOfficeBundle',
                13 => 'SfWebAppCmsBundle',
                14 => 'DebugBundle',
